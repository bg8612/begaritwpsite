...
if ( ! class_exists( 'YITH_Custom_Table' ) ) {
	...
	class YITH_Custom_Table extends WP_List_Table {
		...
		public function prepare_items() {
			...
			$requested   = $_REQUEST;                                                            //phpcs:ignore
			...
			$total_items = $wpdb->get_var( "SELECT COUNT(*) FROM $count_table $count_where" );   //phpcs:ignore
			...
			$this->items = $wpdb->get_results( $sql, ARRAY_A ); //phpcs:ignore
