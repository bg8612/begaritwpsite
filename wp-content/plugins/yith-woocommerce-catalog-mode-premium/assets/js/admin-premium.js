...
jQuery(
	function ( $ ) {
		...
		$( '.ywctm-exclusions #doaction, .ywctm-exclusions #doaction2, .ywctm-exclusions #search-submit, .ywctm-exclusions .pagination-links, .ywctm-exclusions .yith-add-button' ).click(
			function () {
				window.onbeforeunload = '';
			}
		);
